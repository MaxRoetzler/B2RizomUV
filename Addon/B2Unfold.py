...
def set_algorithm(self, context):
    global algorithmCMDStrings, algorithmString
    global hierOP1, hierOP2, hierOP3, hierarchicaloptionsString
...
class UnfoldUVMain(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        if (scn.autoSeamAlgorithm == '0'):
            ...
            #for i, set in enumerate(hierList):
                #hierarchicalOps.prop(scn, "hierSets", index=i, text=set)
